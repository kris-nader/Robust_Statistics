...
write.table(ths.quad.theta, file="covtype_quadrant.txt", row.names=FALSE, col.names=FALSE)
write.table(ths.sp.theta, file="covtype_spearman.txt", row.names=FALSE, col.names=FALSE)
write.table(tws.gauss.theta, file="covtype_gauss.txt", row.names=FALSE, col.names=FALSE)
